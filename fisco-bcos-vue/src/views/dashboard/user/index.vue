        ...
        <div class="cardItem">
          <div class="cardItem_txt">
            <count-to
                    ...
                    :duration="2000"
            ></count-to>
            <p class="cardItem_p1">Business ID</p>
          </div>
        ...
        <div class="cardItem">
          <div class="cardItem_txt">
            <count-to
                    ...
                    :duration="2000"
            ></count-to>
            <p class="cardItem_p1">Business Point Balance</p>
          </div>
          <div class="cardItem_icon">
        ...
        <div class="cardItem">
          <div class="cardItem_txt">
            <count-to
                    ...
                    :duration="2000"
            ></count-to>
            <p class="cardItem_p1">Business Order Placed</p>
          </div>
          <div class="cardItem_icon">
        ...
        <div class="cardItem">
          <div class="cardItem_txt">
            <count-to
                    ...
                    :duration="2000"
            ></count-to>
            <p class="cardItem_p1">Business Money Balance</p>
          </div>
          <div class="cardItem_icon">
    ...
    methods: {
      _getAllData() {
        ...
        this.$http
                ...
                .all([getBusinessData(),getAllDeal(name)])
                .then(
                        this.$http.spread((cardData,bTabData) => {
                          this.vistors = localStorage.getItem('name')
                          this.message = store.getters.point
                          this.order = bTabData.response.length
                          console.log(store.getters.surplus)
                          this.profit = 8599
                          console.log(bTabData)
                          //this.lineChartData = lineData.data
