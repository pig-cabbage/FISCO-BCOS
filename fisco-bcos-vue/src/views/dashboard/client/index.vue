                ...
                <div class="cardItem">
                    <div class="cardItem_txt">
                        <count-to
                                ...
                                :duration="2000"
                        ></count-to>
                        <p class="cardItem_p1">Client ID</p>
                    </div>
                ...
                <div class="cardItem">
                    <div class="cardItem_txt">
                        <count-to
                                ...
                                :duration="2000"
                        ></count-to>
                        <p class="cardItem_p1">Client Point Balance</p>
                    </div>
                    <div class="cardItem_icon">
                ...
                <div class="cardItem">
                    <div class="cardItem_txt">
                        <count-to
                                ...
                                :duration="2000"
                        ></count-to>
                        <p class="cardItem_p1">Goods Order Placed</p>
                    </div>
                    <div class="cardItem_icon">
                ...
                <div class="cardItem">
                    <div class="cardItem_txt">
                        <count-to
                                ...
                                :duration="2000"
                        ></count-to>
                        <p class="cardItem_p1">Client Money Balance</p>
                    </div>
                    <div class="cardItem_icon">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            _getAllData() {
                let params = {userId:store.getters.userName}
                this.$http
                    .all([getBTableData(params)])
                    .then(
                        this.$http.spread((bTabData) => {
                            this.vistors = parseInt(store.getters.userName)
                            this.message = 875
                            this.order = bTabData.response.length
                            this.profit = parseInt(store.getters.surplus)
                            //this.lineChartData = lineData.data
                            this.tableData = bTabData.response
